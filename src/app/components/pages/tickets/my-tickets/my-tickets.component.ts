...
export class MyTicketsComponent implements OnInit {
  ...
  data: any[] = [];
  cols = [ 'id', 'ticket_number', 'reported_by', 'location', 'status', 'contact', 'description', 'created_at' ];
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        this.tickets.getTickets( Object.assign({userId: this.auth.getAuth().user_id }, dataTablesParameters))
          .then(response => {
